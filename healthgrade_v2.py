...
for zipcode in zip_dict.keys():
    ...
    URL = f'https://www.healthgrades.com/usearch?what=Family%20Medicine&entityCode=PS305&searchType=PracticingSpecialty&where=Bay%20Shore%2C%20NY&pt=40.64%2C-73.2&pageNum=1&sort.provider=bestmatch&state=NY&zip=11435'
